...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        else if (this.state.touched.telnum && telnum.length < 3)
            errors.telnum = 'Tel. Number should be >= 3 digits';
                ...
                <div className = "row row-content">
                    ...
                    <div className = "col-12 col-sm-4 offset-sm-1">
                        ...
                        <address>
                            ...
                            <i className = "fa fa-envelope"></i>: <a href="mailto
                                :confusion@food.net">confusion@food.net</a>
                        </address>
                    </div>
